        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto d-md-flex align-items-md-center">
              <Nav className='ms-auto d-md-flex align-items-md-center'>
                <Link to={'whishlist'} className='text-decoration-none text-light fw-bolder d-flex align-items-center '> <FontAwesomeIcon icon={faHeart} className='text-danger me-2' /> Whishlist<Badge bg="secondary">9</Badge></Link>
